...
EXPERIMENT_DIR = Path("experiments") / "vit_b_16"
...
# Меняем классификационную голову под 5 классов
model.heads.head = nn.Linear(
    in_features=model.heads.head.in_features,
    out_features=NUM_CLASSES
)

# Обучаем только новую классификационную голову
...
print("Обучение ViT-Base завершено.")
